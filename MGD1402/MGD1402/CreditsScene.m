...
- (id)init
{
    ...
    lineSix.color = [CCColor whiteColor];
    ...
    lineSeven.color = [CCColor whiteColor];
    ...
    lineEight.color = [CCColor whiteColor];
    ...
    lineNine.color = [CCColor whiteColor];
    ...
    lineTen.color = [CCColor whiteColor];
    ...
    lineEleven.color = [CCColor whiteColor];
    ...
    lineTwelve.color = [CCColor whiteColor];
    ...
    lineThirteen.color = [CCColor whiteColor];
